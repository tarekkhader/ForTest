            ...
            {user ? (
              <>
                ...
                <button
                  type="button"
                  onClick={logout}
                  className="bg-gray-200 text-gray-800 px-3 py-1 rounded-md cursor-pointer text-sm"
                >
                  Log out
                </button>
              </>
              ...
              <Link
                to={"/login"}
                className="bg-[#31859c] text-white px-3 py-1 rounded-md cursor-pointer text-sm"
              >
                Sign in
              </Link>
            )}
